...
Although long-read methods are generally considered better for reconstructing plasmids, some library prep methods (particularly for PacBio) include a size-selection step that can remove very small plasmids before they are sequenced. 
...
- Allocate 4 CPUs to the assembler
    - `--cpus 4`
- Specify a maximum of 4 Gb memory to use
    - `--ram 4`
...
Add your assembly metrics to the google sheet at https://docs.google.com/spreadsheets/d/1nd69T_NjmFiJnRwIIMx1pRnRgq0uE_fp4CZ3jDB2S_Y/edit?usp=sharing
...
When all results are uploaded, we will (hopefully) put summary plots [here](https://github.com/WCSCourses/GenEpiLAC2025/blob/main/course_modules_2025/Assembly_method_comparison/Assembly_Comparison_Results.md)
